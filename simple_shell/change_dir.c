...
/**
 * cd_home - change to home working directory
 *
 * @cmd: struct variable
...
/**
 * cd_back - changes to the previous working directory
 *
 * @cmd: struct variable
 * Return: exit upon success
 */
...
/**
 * cd_curr - changes to the current working directory
 *
 * @cmd: struct variable
 * Return: exit upon success
 */
...
/**
 * cd_path - changes to a directory given by the user
 *
 * @cmd: struct variable
 * @dir: intended directory
